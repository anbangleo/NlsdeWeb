...
(function() {
  var checkEligibility, recaptchaPublicKey, reloadCaptcha, setRequired, submitRegistration;
  ...
  checkEligibility = function() {
    var is_k12, is_student, is_teacher, is_us, ref, ref1, ref2;
    is_us = (ref = $("#country-select").val()) === "US" || ref === "";
    is_k12 = (ref1 = $("#background-select").val()) === "student_el" || ref1 === "student_ms" || ref1 === "student_hs" || ref1 === "student_home";
    is_student = (ref2 = $("#background-select").val()) === "student_el" || ref2 === "student_ms" || ref2 === "student_hs" || ref2 === "student_home" || ref2 === "student_undergrad" || ref2 === "student_grad";
